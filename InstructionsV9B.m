...
%%
[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV9B(ConditionP(32),window,xCenter,yCenter);
...
% 1 is top/same, 3 is bottom/different
...
DrawFixationV9B(1,screenParams);
Screen('Flip',window);
WaitForResponseV9B('noMax');
...
[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV9B(ConditionP(33),window,xCenter,yCenter);

DrawFixationV9B(0,screenParams);
Screen('DrawTexture', window, Test, [], TestPosition, 0);
Screen('DrawTexture', window, Standard, [], StandardPosition, 0);
Screen('Flip',window);
WaitForResponseV9B('noMax');
...
TrialStructureV9B(ConditionP(31),1,screenParams,Timing, ifi);
...
TimingSlowest = [(Timing(1)*2)]; % premask, prime, postmask, stims
ConditionP1 = ConditionP(1:10);
ConditionP1 = randsample(ConditionP1,10);
TrialStructureV9B(ConditionP1,10,screenParams,TimingSlowest, ifi);
...
TimingSlower = [(Timing(1)*1.5)];% premask, prime, postmask, stims
ConditionP2 = ConditionP(11:20);
ConditionP2 = randsample(ConditionP2,10);
TrialStructureV9B(ConditionP2,10,screenParams,TimingSlower, ifi);
...
TrialStructureV9B(ConditionP3,10,screenParams,Timing, ifi);
