function [] = Instructions(ConditionP,screenParams, Timing, ifi)
...
%%
line1 = 'You will be looking at two pictures and judging';
...
%%
[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV4(ConditionP(31),window,xCenter,yCenter);
...
TrialStructureV4(ConditionP(32),1,screenParams,Timing, ifi);
...
TrialStructureV4(ConditionP1,10,screenParams,TimingSlowest, ifi);
...
TrialStructureV4(ConditionP2,10,screenParams,TimingSlower, ifi);
...
TrialStructureV4(ConditionP3,10,screenParams,Timing, ifi);
