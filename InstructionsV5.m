function [] = InstructionsV5(ConditionP,screenParams, Timing, ifi)
...
WaitForResponseV5('noMax');

%%
line1 = 'You will be looking at two objects and judging';
line2 = '\n\n which one is more blurry. Here is an example of what';
...
%%
[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV5(ConditionP(32),window,xCenter,yCenter);
...
line1 = '\n If your answer is the object on the left, press the';
line2 = '\n\n left key. If your answer is the object on the right,';
line3 = '\n\n press the right key.';
...
DrawFixationV5(0,screenParams);
Screen('Flip', window, vbl + (postMaskWait - .5)* ifi);
WaitForResponseV5('noMax');

%% Draw Black Fixation Cross and Display Stims

[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV5(ConditionP(33),window,xCenter,yCenter);
...
TrialStructureV5(ConditionP(31),1,screenParams,Timing, ifi);
...
TrialStructureV5(ConditionP1,10,screenParams,TimingSlowest, ifi);
...
TrialStructureV5(ConditionP2,10,screenParams,TimingSlower, ifi);
...
TrialStructureV5(ConditionP3,10,screenParams,Timing, ifi);
