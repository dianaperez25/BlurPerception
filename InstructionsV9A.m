...
%%
[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV9A(ConditionP(32),window,xCenter,yCenter);
...
[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV9A(ConditionP(33),window,xCenter,yCenter);
...
TrialStructureV9A(ConditionP(31),1,screenParams,Timing, ifi);
...
TrialStructureV9A(ConditionP1,10,screenParams,TimingSlowest, ifi);
...
TrialStructureV9A(ConditionP2,10,screenParams,TimingSlower, ifi);
...
TrialStructureV9A(ConditionP3,10,screenParams,Timing, ifi);
