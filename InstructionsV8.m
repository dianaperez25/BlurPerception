function [] = InstructionsV8(ConditionP,screenParams, Timing, ifi)
...
%%
[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV8(ConditionP(32),window,xCenter,yCenter);
...
[Test, Standard, TestPosition, StandardPosition] = createStimTexturesV8(ConditionP(33),window,xCenter,yCenter);
...
TrialStructureV8(ConditionP(31),1,screenParams,Timing, ifi);
...
TimingSlowest = [Timing(1)*2]; 
ConditionP1 = ConditionP(1:10);
ConditionP1 = randsample(ConditionP1,10);
TrialStructureV8(ConditionP1,10,screenParams,TimingSlowest, ifi);
...
TimingSlower = [Timing(1)*1.5];
ConditionP2 = ConditionP(11:20);
ConditionP2 = randsample(ConditionP2,10);
TrialStructureV8(ConditionP2,10,screenParams,TimingSlower, ifi);
...
TrialStructureV8(ConditionP3,10,screenParams,Timing, ifi);
