...
for n = 1:numTrials
    ...
    [Test, Standard, TestPosition, StandardPosition] = createStimTexturesV9B(Condition(n),window,xCenter,yCenter);
...
%     times(3,n) = vbl;
    ...
    times(2,n) = vbl;
    [Condition(n).Response Condition(n).reactionTime] = WaitForResponseV9B(3,vbl);
