...
for n = 1:numTrials
    ...
    [Test, Standard, TestPosition, StandardPosition] = createStimTexturesV7(Condition(n),window,xCenter,yCenter);
    ...
    times(5,n) = vbl;
    [Condition(n).Response Condition(n).reactionTime] = WaitForResponseV7(3,vbl);
