function [ Condition, times ] = TrialStructureV5(Condition,numTrials,screenParams, Timing, ifi)
...
for n = 1:numTrials
    ...
    [Test, Standard, TestPosition, StandardPosition] = createStimTexturesV5(Condition(n),window,xCenter,yCenter);
    ...
    times(5,n) = vbl;
    Condition(n).Response = WaitForResponseV5(3,vbl);
